      ...
      <div className="max-w-6xl mx-auto px-4">
        ...
        <div className="grid grid-cols-1 md:grid-cols-2 lg:grid-cols-4 gap-8 mb-10">
          ...
          <div className="col-span-1 lg:col-span-2">
            <h3 className="text-xl font-bold mb-4 text-purple-200">IEEE WIE MUJ</h3>
            <p className="text-gray-200 mb-4 max-w-md">
              IEEE Women in Engineering MUJ is dedicated to promoting women engineers and inspiring girls 
              around the world to follow their academic interests in careers in engineering and science.
            </p>
            ...
            <div className="flex space-x-4 mt-6">
              {socialLinks.map(social => (
                <a 
                  ...
                  className="bg-white bg-opacity-10 hover:bg-opacity-20 text-white p-2 rounded-full transition-all duration-300"
          ...
          <div>
            ...
            <ul className="space-y-2">
              {['Home', 'Events', 'Our Team', 'About Us','Gallery'].map((link, index) => (
                <li key={index}>
                  <Link 
          ...
          <div>
            ...
            <div className="space-y-3 text-gray-300">
              <p className="flex items-start">
                <span className="mr-2 mt-1"><EmailIcon /></span>
                <a 
                  href="mailto:ieeewiemuj@gmail.com" 
              ...
              <p className="flex items-start">
                <span className="mr-2 mt-1"><LocationIcon /></span>
                <span>Manipal University Jaipur,<br />Dehmi Kalan, Jaipur, Rajasthan</span>
              </p>
            </div>
          </div>
        </div>
